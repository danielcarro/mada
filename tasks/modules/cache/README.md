...
This folder is an operational micro-memory for **cache**.

## Purpose

Use this module for application cache, HTTP cache, in-memory cache, distributed cache, invalidation and freshness.
