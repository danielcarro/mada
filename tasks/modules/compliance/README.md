...
This folder is an operational micro-memory for **compliance**.

## Purpose

Use this module for privacy, legal requirements, audit readiness, data retention, consent, policies and regulatory constraints.
