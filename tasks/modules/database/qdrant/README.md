...
This folder is an operational micro-memory for **database/qdrant**.

## Purpose

Use this module for vector database, collections, embeddings, semantic search, RAG and knowledge isolation.
