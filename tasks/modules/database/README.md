...
This folder is an operational micro-memory for **database**.

## Purpose

Use this module for data modeling, persistence, migrations, repositories, seeds, queries and integrity.
