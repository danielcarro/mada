...
This folder is an operational micro-memory for **database/mysql**.

## Purpose

Use this module for relational database work, tables, indexes, migrations, seeds and transactional queries.
...
- adjust relational schema.
- plan migrations.
- validate indexes.
- review critical queries.
- record risks before changing data.
