...
This folder is an operational micro-memory for **records**.

## Purpose

Use this module for business records, lists, imports, normalization, deduplication and data maintenance.
