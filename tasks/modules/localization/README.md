...
This folder is an operational micro-memory for **localization**.

## Purpose

Use this module for translations, locale formats, timezone rules, currencies, language files and internationalization behavior.
