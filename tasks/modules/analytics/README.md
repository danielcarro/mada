...
This folder is an operational micro-memory for **analytics**.

## Purpose

Use this module for events, funnels, product metrics, dashboards, tracking plans and measurement quality.
