...
This folder is an operational micro-memory for **architecture**.

## Purpose

Use this module for system design, boundaries, modules, layers, dependencies, tradeoffs, technical decisions and diagrams.
