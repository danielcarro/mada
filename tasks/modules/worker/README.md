...
This folder is an operational micro-memory for **worker**.

## Purpose

Use this module for jobs, queues, consumers, schedulers, asynchronous processing, retries, idempotency and background execution.
