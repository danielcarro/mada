...
This folder is an operational micro-memory for **tooling**.

## Purpose

Use this module for developer tools, generators, formatters, linters, local scripts, editor setup and automation helpers.
