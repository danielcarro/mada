...
This folder is an operational micro-memory for **scripts**.

## Purpose

Use this module for automation scripts, maintenance scripts, setup scripts, one-off utilities and safe command wrappers.
