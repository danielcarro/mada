...
This folder is an operational micro-memory for **communications**.

## Purpose

Use this module for email, SMS, WhatsApp, push, chat, notifications, providers, templates, webhooks and delivery history.
