...
This folder is an operational micro-memory for **infrastructure**.

## Purpose

Use this module for cloud resources, servers, containers, networks, domains, queues, runtime services and external infrastructure.
