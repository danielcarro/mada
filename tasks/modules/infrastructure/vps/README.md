# Module: VPS Infrastructure

This folder is an operational micro-memory for **infrastructure/vps**.

## Purpose

Use this module for servers, processes, runtime, PM2 or equivalent tools, backend or worker deployment, logs and operational maintenance.
...
- validate processes.
- inspect logs.
- execute authorized deployments.
- record administrative risks.
