...
This folder is an operational micro-memory for **infrastructure/docker**.

## Purpose

Use this module for containers, compose files, images, volumes, networks, ports and isolated local environments.
