...
This folder is an operational micro-memory for **ux**.

## Purpose

Use this module for user experience, usability, flows, information architecture, copy, onboarding and interaction quality.
