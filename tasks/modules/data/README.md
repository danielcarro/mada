...
This folder is an operational micro-memory for **data**.

## Purpose

Use this module for data flows, ETL, imports, exports, transformations, validation, datasets and data quality.
