...
This folder is an operational micro-memory for **tests**.

## Purpose

Use this module for unit tests, integration tests, smoke tests, e2e tests, typecheck, lint, build, manual validation and evidence.
