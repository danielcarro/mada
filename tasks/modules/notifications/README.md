...
This folder is an operational micro-memory for **notifications**.

## Purpose

Use this module for in-app notifications, push notifications, transactional alerts, preferences and delivery states.
