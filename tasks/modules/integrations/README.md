...
This folder is an operational micro-memory for **integrations**.

## Purpose

Use this module for third-party APIs, SDKs, credentials, webhooks, adapters, retries and external service boundaries.
