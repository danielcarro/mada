...
This folder is an operational micro-memory for **desktop**.

## Purpose

Use this module for desktop application code, native windows, local integrations, installers and desktop runtime behavior.
