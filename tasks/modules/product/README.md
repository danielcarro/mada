...
This folder is an operational micro-memory for **product**.

## Purpose

Use this module for product goals, personas, user journeys, feature prioritization, acceptance criteria and business context.
