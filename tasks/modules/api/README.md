...
This folder is an operational micro-memory for **api**.

## Purpose

Use this module for HTTP APIs, RPC APIs, endpoints, handlers, request validation, response format, status codes and rate limits.
