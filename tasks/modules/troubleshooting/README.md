...
This folder is an operational micro-memory for **troubleshooting**.

## Purpose

Use this module for debugging, incident investigation, failing flows, logs, reproduction steps and root cause analysis.
