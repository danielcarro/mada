...
This folder is an operational micro-memory for **design**.

## Purpose

Use this module for visual design, UI direction, design systems, components, tokens and design-to-code alignment.
