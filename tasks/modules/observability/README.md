...
This folder is an operational micro-memory for **observability**.

## Purpose

Use this module for logs, audit trails, metrics, tracing, health checks, rate limits, alerts, troubleshooting and evidence.
