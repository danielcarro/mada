...
This folder is an operational micro-memory for **routes**.

## Purpose

Use this module for URL structure, application routes, redirects, route groups, navigation and entry points.
