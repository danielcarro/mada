...
This folder is an operational micro-memory for **workflows**.

## Purpose

Use this module for business workflows, process orchestration, state machines, approvals, scheduling and long-running flows.
