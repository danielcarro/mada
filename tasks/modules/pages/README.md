...
This folder is an operational micro-memory for **pages**.

## Purpose

Use this module for pages, screens, route-level views, visual navigation, public areas and authenticated areas.
