...
This folder is an operational micro-memory for **pages/layout**.

## Purpose

Use this module for shells, headers, sidebars, breadcrumbs, menus, layout regions and page composition.
