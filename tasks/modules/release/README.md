...
This folder is an operational micro-memory for **release**.

## Purpose

Use this module for release notes, versioning, changelogs, publish steps, rollout plans and post-release checks.
