...
This folder is an operational micro-memory for **state-management**.

## Purpose

Use this module for client state, server state, cache state, stores, synchronization and optimistic updates.
