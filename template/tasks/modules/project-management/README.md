...
This folder is an operational micro-memory for **project-management**.

## Purpose

Use this module for planning, milestones, backlog, sequencing, task breakdown, estimates and delivery tracking.
