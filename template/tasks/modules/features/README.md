...
This folder is an operational micro-memory for **features**.

## Purpose

Use this module for cross-cutting feature requests that do not clearly belong to a more specific module yet.
...
- understand broad requests.
- split scope into modules.
- record product decisions.
- organize micro-memories.
- move work to a specific module when possible.
