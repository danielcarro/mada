...
This folder is an operational micro-memory for **permissions**.

## Purpose

Use this module for authorization, RBAC, roles, policies, guards, route access, endpoint access and action limits.
