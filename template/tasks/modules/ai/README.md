...
This folder is an operational micro-memory for **ai**.

## Purpose

Use this module for AI features, copilots, agents, prompts, tools, memory, RAG and supervised actions.
