...
This folder is an operational micro-memory for **deployment**.

## Purpose

Use this module for deployment targets, releases, rollbacks, production checks, staging checks and deployment evidence.
