...
This folder is an operational micro-memory for **accessibility**.

## Purpose

Use this module for a11y requirements, keyboard navigation, semantics, screen readers, contrast and inclusive UX.
