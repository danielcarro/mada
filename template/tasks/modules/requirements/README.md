...
This folder is an operational micro-memory for **requirements**.

## Purpose

Use this module for functional requirements, non-functional requirements, constraints, assumptions and acceptance rules.
...
- record constraints.
- clarify assumptions.
- turn requests into verifiable criteria.
