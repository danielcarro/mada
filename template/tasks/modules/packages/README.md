...
This folder is an operational micro-memory for **packages**.

## Purpose

Use this module for reusable packages, libraries, internal modules, exports, versioning and package boundaries.
