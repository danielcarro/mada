...
This folder is an operational micro-memory for **qa**.

## Purpose

Use this module for quality assurance, acceptance checks, regression plans, manual test scripts and release confidence.
