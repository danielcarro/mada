...
This folder is an operational micro-memory for **monorepo**.

## Purpose

Use this module for workspace layout, packages, apps, dependency graph, build order and cross-package conventions.
...
- align package boundaries.
- validate build order.
- document shared conventions.
- avoid cross-package drift.
