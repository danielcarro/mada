...
This folder is an operational micro-memory for **validation**.

## Purpose

Use this module for input validation, schema validation, data normalization, constraints and safe parsing.
