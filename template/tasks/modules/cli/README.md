...
This folder is an operational micro-memory for **cli**.

## Purpose

Use this module for command-line tools, scripts exposed as commands, arguments, flags, terminal UX and command validation.
