...
This folder is an operational micro-memory for **docs**.

## Purpose

Use this module for documentation, guides, architecture notes, setup docs, user docs, developer docs and documentation maintenance.
