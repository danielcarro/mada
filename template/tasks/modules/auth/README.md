...
This folder is an operational micro-memory for **auth**.

## Purpose

Use this module for authentication, sessions, login, signup, password recovery, identity, invitations and secure access.
...
- create auth flows.
- validate sessions and cookies.
- implement password recovery.
- connect identity to permissions.
- record access risks.
