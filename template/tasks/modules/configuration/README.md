...
This folder is an operational micro-memory for **configuration**.

## Purpose

Use this module for environment variables, config files, feature flags, runtime options and safe configuration loading.
