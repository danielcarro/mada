...
This folder is an operational micro-memory for **payments**.

## Purpose

Use this module for payments, subscriptions, invoices, credits, usage, billing providers, financial webhooks and reconciliation.
...
- validate webhooks.
- record usage and balance.
- audit payment inconsistencies.
