...
This folder is an operational micro-memory for **contracts**.

## Purpose

Use this module for DTOs, schemas, types, enums, API contracts, event contracts and interfaces between layers.
