...
This folder is an operational micro-memory for **user**.

## Purpose

Use this module for users, profiles, accounts, preferences, members, personal data and individual user experience.
