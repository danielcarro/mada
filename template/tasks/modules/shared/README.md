...
This folder is an operational micro-memory for **shared**.

## Purpose

Use this module for shared utilities, shared components, common schemas, constants, helpers and cross-cutting code.
