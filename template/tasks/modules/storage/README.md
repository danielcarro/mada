...
This folder is an operational micro-memory for **storage**.

## Purpose

Use this module for file storage, uploads, downloads, blobs, media, object storage and retention rules.
