# Permanent Task Manager - Domain Infrastructure

Status: waiting for orders.

This folder is ready to receive requests for **infrastructure/domains**. No product task is
active right now.
