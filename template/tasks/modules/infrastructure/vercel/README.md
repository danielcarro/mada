# Module: Vercel Infrastructure

This folder is an operational micro-memory for **infrastructure/vercel**.

## Purpose

Use this module for Vercel deployments, projects, builds, environment variables, logs, domains and post-deploy checks.
