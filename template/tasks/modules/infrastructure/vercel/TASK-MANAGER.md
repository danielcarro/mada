# Permanent Task Manager - Vercel Infrastructure

Status: waiting for orders.

This folder is ready to receive requests for **infrastructure/vercel**. No product task is
active right now.
